...
<Frame>
  ![Screenshot of the Send Discord Message action block](/images/send-discord-message-block-hero.png)
</Frame>
...
<Frame>
  ![Screenshot of a Discord message sent using the Send Discord Message action block](/images/send-discord-message-demo-1.png)